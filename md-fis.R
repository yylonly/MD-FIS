...
allX<- read.csv("alldata.csv")
extra <- read.csv("alldata.csv")
...
write.csv(FinalTestingSet, "testingset.csv", row.names = FALSE)
write.csv(FinalTrainingSet, "trainingset.csv", row.names = FALSE)
write.csv(UnScaledFinalTestingSet, "testingset(readyforcheck).csv", row.names = FALSE)
write.csv(UnScaledFinalTrainingSet, "trainingset(readyforcheck).csv", row.names = FALSE)
write.csv(scaledextradata, "extrascaledtestset.csv", row.names = FALSE)